...
<head>
    ...
    <link rel="stylesheet" href="<?= url('assets/template/') ?>vendors/datatables.net-bs4/dataTables.bootstrap4.css">
...
<body>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="index.html"><img src="<?= url('assets/template/') ?>images/logo.svg" alt="logo" /></a>
                    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?= url('assets/template/') ?>images/logo-mini.svg" alt="logo" /></a>
    ...
    <script src="<?= url('assets/template/') ?>vendors/chart.js/Chart.min.js"></script>
    <script src="<?= url('assets/template/') ?>vendors/datatables.net/jquery.dataTables.js"></script>
    <script src="<?= url('assets/template/') ?>vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
    ...
    <script src="<?= url('assets/template/') ?>js/dashboard.js"></script>
    <script src="<?= url('assets/template/') ?>js/data-table.js"></script>
    <script src="<?= url('assets/template/') ?>js/jquery.dataTables.js"></script>
